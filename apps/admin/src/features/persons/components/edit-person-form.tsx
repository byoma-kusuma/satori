...
function EditPersonForm({ personId }: { personId: string }) {
  ...
  const onSubmit = (vals: PersonForm) => {
    // Convert "none" back to null for krama_instructor_person_id and handle empty strings
    const processedVals = {
      ...vals,
      krama_instructor_person_id: vals.krama_instructor_person_id === "none" ? null : vals.krama_instructor_person_id,
      emergencyContactName: vals.emergencyContactName?.trim() || null,
      emergencyContactRelationship: vals.emergencyContactRelationship?.trim() || null,
      emergencyContactPhone: vals.emergencyContactPhone?.trim() || null,
    };
