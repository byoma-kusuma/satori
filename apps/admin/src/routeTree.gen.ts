...
const AuthenticatedRegistrationsIndexLazyImport = createFileRoute(
...
const AuthenticatedCentersIndexLazyImport = createFileRoute(
...
const AuthenticatedRegistrationsIndexLazyRoute =
  AuthenticatedRegistrationsIndexLazyImport.update({
    id: '/registrations/',
    path: '/registrations/',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any).lazy(() =>
...
const AuthenticatedPersonsIndexLazyRoute =
  AuthenticatedPersonsIndexLazyImport.update({
    id: '/persons/',
    path: '/persons/',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any).lazy(() =>
...
const AuthenticatedCentersIndexLazyRoute =
  AuthenticatedCentersIndexLazyImport.update({
    id: '/centers/',
    path: '/centers/',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any).lazy(() =>
    import('./routes/_authenticated/centers/index.lazy').then((d) => d.Route),
  )
...
const AuthenticatedPersonsCreateLazyRoute =
  AuthenticatedPersonsCreateLazyImport.update({
    id: '/persons/create',
    path: '/persons/create',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any).lazy(() =>
...
const AuthenticatedCentersCenterIdIndexLazyRoute =
  AuthenticatedCentersCenterIdIndexLazyImport.update({
    ...
    import('./routes/_authenticated/centers/$centerId/index.lazy').then(
      (d) => d.Route,
    ),
  )
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/persons/create': {
      id: '/_authenticated/persons/create'
      path: '/persons/create'
      fullPath: '/persons/create'
      preLoaderRoute: typeof AuthenticatedPersonsCreateLazyImport
      parentRoute: typeof AuthenticatedRouteImport
    }
    '/_authenticated/settings/account': {
    ...
    '/_authenticated/centers/': {
      ...
      path: '/centers'
      fullPath: '/centers'
      preLoaderRoute: typeof AuthenticatedCentersIndexLazyImport
      parentRoute: typeof AuthenticatedRouteImport
    }
    '/_authenticated/chats/': {
    ...
    '/_authenticated/persons/': {
      ...
      path: '/persons'
      fullPath: '/persons'
      preLoaderRoute: typeof AuthenticatedPersonsIndexLazyImport
      parentRoute: typeof AuthenticatedRouteImport
    }
    '/_authenticated/registrations/': {
      ...
      preLoaderRoute: typeof AuthenticatedRegistrationsIndexLazyImport
      parentRoute: typeof AuthenticatedRouteImport
    }
    '/_authenticated/settings/': {
      id: '/_authenticated/settings/'
...
export interface FileRoutesByFullPath {
  ...
  '/persons/create': typeof AuthenticatedPersonsCreateLazyRoute
...
export interface FileRoutesById {
  ...
  '/_authenticated/persons/create': typeof AuthenticatedPersonsCreateLazyRoute
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/_authenticated/persons/create": {
      "filePath": "_authenticated/persons/create.lazy.tsx",
      "parent": "/_authenticated"
    },
    "/_authenticated/settings/account": {
    ...
    "/_authenticated/centers/": {
      "filePath": "_authenticated/centers/index.lazy.tsx",
      "parent": "/_authenticated"
    },
    "/_authenticated/chats/": {
    ...
    "/_authenticated/registrations/": {
      "filePath": "_authenticated/registrations/index.lazy.tsx",
      "parent": "/_authenticated"
    },
    "/_authenticated/settings/": {
